...
public class Fachada {
	...
	/*public static Participante localizarParticipante(String nome) throws  Exception{
	...
	public static List<Participante> consultaA(String nome, int mes) throws Exception{
		...
		List<Participante> reuniaoMes = daoreuniao.searchParticipantes(nome, mes);
	...
	public static List<Reuniao> consultaB( )throws Exception{
		...
		List<Reuniao> convidados = daoreuniao.meetinGuest();
		if(convidados.size() == 0)
			throw new Exception("Não existe convidados nas reuniões ");
